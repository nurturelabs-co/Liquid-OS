...
from . import _pydantic, _utils, models
...
ToolFuncEither = Union[
    ToolFuncContext[AgentDeps, ToolParams], ToolFuncPlain[ToolParams]
]
"""Either kind of tool function.

This is just a union of [`ToolFuncContext`][liquid_os.tools.ToolFuncContext] and
[`ToolFuncPlain`][liquid_os.tools.ToolFuncPlain].
...
from liquid_os import RunContext, Tool
from liquid_os.tools import ToolDefinition
...
class Tool(Generic[AgentDeps]):
    ...
    def __init__(
        ...
        *,
        ...
        ```python {noqa="I001"}
        from liquid_os import Agent, RunContext, Tool
        ...
        Args:
            ...
            takes_ctx: Whether the function takes a [`RunContext`][liquid_os.tools.RunContext] first argument,
            ...
            client_side: If True, the agent will not execute this tool's function; instead it will
                return a special marker for the client to handle externally.
        """
    ...
    def _call_args(
        ...
        ctx = dataclasses.replace(
            run_context, retry=self.current_retry, tool_name=message.tool_name
        )
...
This type is used to define tools parameters (aka arguments) in [ToolDefinition][liquid_os.tools.ToolDefinition].
