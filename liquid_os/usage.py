...
class Usage:
    ...
    Responsibility for calculating usage is on the model; LiquidOS simply sums the usage information across requests.
...
class UsageLimits:
    ...
    The request count is tracked by liquid_os, and the request limit is checked before each request to the model.
