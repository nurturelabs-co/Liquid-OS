...
class OllamaModel(Model):
    ...
    def __init__(
        ...
        *,
        ...
        [`OpenAIModel`][liquid_os.models.openai.OpenAIModel] here.
        ...
        if openai_client is not None:
            ...
            self.openai_model = OpenAIModel(
                model_name=model_name, openai_client=openai_client
            )
        else:
            ...
            oai_client = AsyncOpenAI(
                base_url=base_url, api_key=api_key, http_client=http_client_
            )
            self.openai_model = OpenAIModel(
                model_name=model_name, openai_client=oai_client
            )
