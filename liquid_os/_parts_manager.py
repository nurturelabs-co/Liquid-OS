...
and produces LiquidOS-format events as appropriate for consumers of the streaming APIs.

The "vendor-specific identifiers" to use depend on the semantics of the responses of the responses from the vendor,
and are tightly coupled to the specific model being used, and the LiquidOS Model subclass implementation.
...
from liquid_os.exceptions import UnexpectedModelBehavior
from liquid_os.messages import (
    ModelResponsePart,
...
class ModelResponsePartsManager:
    ...
    def handle_tool_call_part(
        ...
        *,
        ...
        """
        new_part = ToolCallPart.from_raw_args(
